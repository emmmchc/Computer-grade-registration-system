...
<body style="text-align: center;">
	<div style="width:350px; margin-left: 35%">
		<input id="stuid" type="hidden" value="${sessionScope.student.studentNumber}">
		<table cellspacing="10px" cellpadding="10px">
			<tr>
				<td align="right">账号：</td>
				<td><input id="name" type="text" disabled="false" value="${sessionScope.student.studentName}"/></td>
			</tr>
			<tr>
